...
function Feature() {
  ...
  function handleLaptopCategoryButton() {
    navigate("/shop");
    window.scrollTo(0, 0);
  }

  function handleMicrophoneCategoryButton() {
    navigate("/shop");
    window.scrollTo(0, 0);
  }

  function handleWearablesCategoryButton() {
    navigate("/shop");
    window.scrollTo(0, 0);
  }
          ...
          <div className=" h-auto md:h-150 w-full grid grid-cols-1 md:grid-rows-2 md:grid-cols-12 gap-6">
            ...
            <div className="group/bento-image-1 h-75 md:h-full w-full relative col-span-1 md:row-span-2 md:col-span-8 rounded-xl overflow-clip starting:opacity-0 starting:translate-y-6 opacity-100 translate-y-0 transition-all duration-500 delay-300">
              ...
              <div className="mb-3 ml-5 md:ml-8 absolute bottom-0 z-2">
                ...
                <button
                  onClick={handleLaptopCategoryButton}
                  className="group/button flex items-center gap-2 text-xs text-[#adc6ff] font-medium transition-all duration-1200 cursor-pointer hover:text-[#4989f6] translate-y-6 opacity-0 group-hover/bento-image-1:translate-y-0 group-hover/bento-image-1:opacity-100">
                  Explore Laptops
            ...
            <div className="group/bento-image-2 h-75 md:h-full w-full relative md:col-span-4 rounded-xl overflow-clip starting:opacity-0 starting:translate-y-6 opacity-100 translate-y-0 transition-all duration-500 delay-500">
              ...
              <div className="mb-3 ml-5 absolute bottom-0 z-2">
                ...
                <button
                  onClick={handleMicrophoneCategoryButton}
                  className="group/button flex items-center gap-2 text-xs text-[#adc6ff] font-medium transition-all duration-1200 cursor-pointer hover:text-[#4989f6] translate-y-1 opacity-0 group-hover/bento-image-2:translate-y-0 group-hover/bento-image-2:opacity-100">
                  Shop Sound
                  <span className="material-symbols-outlined relative text-sm! text-[#adc6ff] font-medium! transition-all group-hover/button:text-[#4989f6] group-hover/button:translate-x-1">
                    arrow_forward
                  </span>
            ...
            <div className="group/bento-image-3 h-75 md:h-full w-full relative md:col-span-4 rounded-xl overflow-clip starting:opacity-0 starting:translate-y-6 opacity-100 translate-y-0 transition-all duration-500 delay-600">
              ...
              <div className="mb-3 ml-5 absolute bottom-0 z-2">
                ...
                <button
                  onClick={handleWearablesCategoryButton}
                  className="group/button flex items-center gap-2 text-xs text-[#adc6ff] font-medium transition-all duration-1200 cursor-pointer hover:text-[#4989f6] translate-y-1 opacity-0 group-hover/bento-image-3:translate-y-0 group-hover/bento-image-3:opacity-100">
                  Shop Smart
                  <span className="material-symbols-outlined relative text-sm! text-[#adc6ff] font-medium! transition-all group-hover/button:text-[#4989f6] group-hover/button:translate-x-1">
                    arrow_forward
                  </span>
