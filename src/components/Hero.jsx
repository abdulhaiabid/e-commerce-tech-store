      ...
      <section className="relative h-180 w-full bg-[#131313] ">
        ...
        <div className="h-full max-w-7xl mx-auto px-8 grid grid-cols-12 gap-6 items-center">
          <div className="relative z-1 col-span-12 sm:col-span-5 flex flex-col">
            <p className="mb-4 flex items-center gap-2 text-xs text-[#adc6ff] tracking-widest font-medium starting:opacity-0 opacity-100 transition-all duration-500 delay-700">
              <span className="inline-block size-2 bg-[#adc6ff] rounded-full animate-pulse"></span>
              FLAGSHIP RELEASE
            </p>
            ...
            <p className="mb-8 text-sm md:text-lg text-[#c1c6d7] starting:opacity-0 starting:translate-y-6 opacity-100 translate-y-0 transition-all duration-500 delay-400">
              Experience the next generation of acoustic engineering with our
              new Quantum Series headphones. Uncompromising sound, absolute
              isolation.
            </p>
