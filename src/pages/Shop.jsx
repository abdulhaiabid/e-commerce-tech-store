...
function Shop() {
  ...
  function MainContent() {
    return (
      <>
        <div className="size-full sm:px-12 py-24 col-span-1 flex flex-col">
          ...
          {/* Search Box */}
          {/* <div className="mt-8 flex justify-center items-center starting:opacity-0 starting:translate-y-6 opacity-100 translate-y-0 transition-all duration-500 delay-300">
            <div className="w-full flex justify-center items-stretch rounded-lg transition-all duration-300 focus-within:ring-1 focus-within:ring-[#2563eb] overflow-hidden">
              <input
              ...
              <button className="px-2 sm:px-6 flex justify-center items-center bg-[#353534] border-r border-y border-[#414755] rounded-r-lg  outline-0 cursor-pointer">
                <span className="material-symbols-outlined text-md! sm:text-xl!">
                  search
                </span>
              </button>
            </div>
